(function (global, factory) {
      ...
      slice.fragments.forEach(function (fragment) {
        ...
        if (!drawing) {
          ...
          if (tag.q === 1 || tag.q === 0 || tag.q === 3) {
            cssText += 'word-break:normal;white-space:normal;';
          }
          if (tag.q === 2) {
            cssText += 'word-break:normal;white-space:normal;';
          }
        ...
        if (hasTransfrom) {
          ...
          if (!drawing) {
            cssText += 'transform-style:preserve-3d;word-break:normal;white-space:normal;';
          }
        }
        if (animationName) {
  ...
  function renderer(dialogue) {
    ...
    if (parseInt($div.style.height) !== $div.scrollHeight) {
      $div.style.top = (parseInt($div.style.top) - ($div.scrollHeight - parseInt($div.style.height))) + "px";
